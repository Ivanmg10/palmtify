...
export default function LateralComponentCards() {
  return (
    <div className="p-2 bg-[#121212] rounded-lg">
      ...
      <div className="flex flex-row justify-start items-center gap-3 p-4 hover:scale-101 transition duration-300 cursor-pointer">
        <div>
          <IconSearch stroke={2} size={24} className="m-auto" />
        </div>
