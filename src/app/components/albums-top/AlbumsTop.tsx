    ...
    <div>
      <div className="relative flex flex-row justify-start items-end gap-2 rounded-t-lg overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url(${album[0].strAlbumThumb})`,
        ...
        <div className="relative z-10 flex flex-row items-end gap-2 p-5">
          <Image
          ...
          <div className="flex flex-col justify-center gap-1 pl-7">
            <p className="text-[#b3b3b3]">Album</p>
            <p className="text-8xl font-bold py-1">{album[0].strAlbum}</p>
            <div className="flex flex-row gap-2 py-1 items-center">
              ...
              <p className="text-[#b3b3b3]">{getAllMiliseconds()}</p>
            </div>
          </div>
        </div>
      </div>
